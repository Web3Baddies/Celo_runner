...
import { FarcasterBranding } from '@/components/FarcasterBranding';
        ...
        {!isConnected || !player?.isRegistered ? (
          ...
          <div className="relative w-full flex justify-center px-2 sm:px-4">
            <div className="w-full max-w-[420px] space-y-3">
              <div className="rounded-xl border-4 border-[#2d334a] bg-[#dff8ff] shadow-lg overflow-hidden">
                <SimpleGameCanvas />
              </div>
              <div className="rounded-xl border-2 border-[#2d334a] bg-white/90 shadow-md p-2 sm:p-3">
                <GameUI />
              </div>
            </div>
          </div>
